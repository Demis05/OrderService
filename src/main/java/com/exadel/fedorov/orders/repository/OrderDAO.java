...
public class OrderDAO {
    ...
    public void createOrderRecordWithProcedure(Order order, List<OrderDetail> details) {
        ...
        SqlParameterSource in = new MapSqlParameterSource()
                .addValue(STATUS_DESCRIPTION_FIELD, order.getStatusDescription())
                .addValue(CLIENT_NAME_FIELD, order.getClientName())
                .addValue(TOTAL_PRICE_FIELD, Double.valueOf(order.getTotalPrice().toString()))
